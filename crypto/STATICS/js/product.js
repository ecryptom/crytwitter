...
sendReplyIcon.forEach(element => {
    element.addEventListener("click", function(e) {
        ...
        if (replyBox == null) {
            ...
            replyElement.innerHTML = "  <form action='/product/reply_product_comment/" + element.id + "' method='POST'><textarea placeholder='متن دیدگاه' name='text' class='product-comments-send-reply-text-area'></textarea><button type='submit' class='product-comments-send-reply-submit'>ارسال پاسخ</button></form>";
